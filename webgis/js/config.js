const APP_CONFIG = {
  ...
  paths: {
    ...
    groundTruth2024:
      "./data/spatial/ground_truth_ambon_2024_200_webgis.geojson",
    groundTruth2025:
      "./data/spatial/ground_truth_ambon_2025_200_webgis.geojson",
    featureSamples2024:
      "./data/spatial/feature_stack_samples_ambon_2024_200_v2.geojson",
    featureSamples2025:
      "./data/spatial/feature_stack_samples_ambon_2025_200.geojson",
    ...
    summary:
      "./data/statistics/Ringkasan_Perubahan_Kuantitatif_Ambon_2024_2025.csv",
  ...
  colors: {
    boundary: "#102c3a",
    districts: "#8bc34a",
    vegetation2024: "#27ae60",
    vegetation2025: "#2980b9",
    gain: "#f1c40f",
    loss: "#e74c3c",
    groundTruthVeg: "#27ae60",
    groundTruthNon: "#e74c3c",
    feature2024: "#8bc34a",
    feature2025: "#f39c12",
    stableNon: "#bdc3c7",
    stableVeg: "#27ae60",
